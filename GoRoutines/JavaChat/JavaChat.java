// JavaChat.java
// Code borrowed from University of Otago, COSC244 Lab Materials, September 2014
// Edited by Emery Otopalik, September 2014
...
public class JavaChat {
	...
	public static void main(String [] args) {
		try {
			new JavaChat().startServer(Integer.parseInt(args[0]));
		} catch (Exception e) {
			e.printStackTrace();
			System.err.println("\nUsage: java JavaChat <port>");
		}
	}
